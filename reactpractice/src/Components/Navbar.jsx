  ...
  return (
    <nav className="relative bg-white shadow dark:bg-gray-800">
      <div className="container px-6 py-3 mx-auto md:flex">
        ...
        {/* Menu Items */}
        <div
          className={`transition-all duration-300 ease-in-out absolute inset-x-0 z-20 w-full px-6 py-4 bg-white dark:bg-gray-800 md:mt-0 md:p-0 md:top-0 md:relative md:opacity-100 md:translate-x-0 md:flex md:items-center md:justify-between
          ...
          <div className="flex flex-col px-2 -mx-4 md:flex-row md:mx-10 md:py-0">
            {menuItems.map((item, index) => (
              <Link
                key={index}
                to={item.path}
                className="px-2.5 py-2 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 md:mx-2 rounded-lg"
              >
                {item.name}
              </Link>
            ))}
